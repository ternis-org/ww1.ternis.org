...
return [
    ...
    'nameservers' => [
        'title'            => 'Autonome Nameserver-Infrastruktur',
        'subtitle'         => 'ternis.org betreibt eigene unabhängige, quelloffene Nameserver für transparente Routen, Ausfallsicherheit und europäische digitale Souveränität.',
        ...
        'node1_desc'       => 'Primärer autoritativer Routing-Knoten für alle Domains von ternis.org. Ohne Telemetrie und ausgelegt für verlässliche globale Namensauflösung.',
        'node2_title'      => 'Sekundärer Nameserver (NS2)',
        'node2_host'       => 'two.ns.ternis.net',
        'node2_alias'      => 'example-dns.org',
        'node2_desc'       => 'Geografisch redundanter Sekundärknoten für Hochverfügbarkeit, kontinuierliche Zonensynchronisation und Ausfallsicherheit.',
        'domains_title'    => 'Eigene Domains & TLD-Netzwerk',
        'domains_desc'     => 'ternis.org besitzt example-dns.com, example-dns.net und example-dns.org. Sämtliche DNS-Zonen werden über dnbx.de (von ternis.dev) verwaltet.',
        'terminal_title'   => 'DNS-Verifikation (dig & host)',
        'btn_visit'        => 'example-dns.com besuchen',
        'btn_github'       => 'GitHub',
        'btn_codeberg'     => 'Codeberg',
        'btn_dnbx'         => 'Verwaltet über dnbx.de',
    ],

...
<!-- Bento Grid Section (Architecture & Ecosystem) -->
<section id="ecosystem" class="bento-section">
    <div class="container">
        <div class="section-header" style="margin-bottom: 2.5rem;">
            <span class="badge badge-primary" style="margin-bottom: 0.75rem; display: inline-block;"><?= e(t('bento.badge')) ?></span>
            <h2><?= e(t('bento.title')) ?></h2>
            <p class="section-subtitle"><?= e(t('bento.subtitle')) ?></p>
        </div>

        <div class="bento-grid">
            <!-- Bento Card 1 (Span 2): 100% Free & Open Source -->
            <div class="bento-card bento-col-2">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-primary"><?= e(t('bento.card_foss_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_foss_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_foss_desc')) ?></p>
                    <div class="bento-code-snippet">
                        <span style="color:var(--text-muted);">$</span> git clone https://github.com/ternis-org/ww1.ternis.org.git
                    </div>
                </div>
                <div class="bento-card-footer">
                    <div class="bento-status-pill">
                        <span class="status-dot-pulse"></span>
                        <span><?= e(t('bento.card_foss_status')) ?></span>
                    </div>
                    <a href="https://github.com/ternis-org" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-sm">
                        <span><?= e(t('bento.card_foss_action')) ?></span>
                    </a>
                </div>
            </div>

            <!-- Bento Card 2 (Span 1): Zero Trackers & Privacy -->
            <div class="bento-card bento-col-1">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-secondary"><?= e(t('bento.card_privacy_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_privacy_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_privacy_desc')) ?></p>
                    <div class="bento-badge-group">
                        <span class="badge badge-secondary" style="font-size:0.75rem;">No Cookies</span>
                        <span class="badge badge-secondary" style="font-size:0.75rem;">No Analytics</span>
                        <span class="badge badge-secondary" style="font-size:0.75rem;">EU-Hosted</span>
                    </div>
                </div>
                <div class="bento-card-footer">
                    <div class="bento-metric">
                        <span class="bento-metric-val"><?= e(t('bento.card_privacy_stat')) ?></span>
                        <span class="bento-metric-sub"><?= e(t('bento.card_privacy_sub')) ?></span>
                    </div>
                </div>
            </div>

            <!-- Bento Card 3 (Span 1): Performance -->
            <div class="bento-card bento-col-1">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-accent"><?= e(t('bento.card_perf_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_perf_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_perf_desc')) ?></p>
                    <div class="bento-badge-group">
                        <span class="badge badge-accent" style="font-size:0.75rem;">Immutable Cache</span>
                        <span class="badge badge-accent" style="font-size:0.75rem;">Brotli</span>
                        <span class="badge badge-accent" style="font-size:0.75rem;">HTTP/2+</span>
                    </div>
                </div>
                <div class="bento-card-footer">
                    <div class="bento-metric">
                        <span class="bento-metric-val"><?= e(t('bento.card_perf_stat')) ?></span>
                        <span class="bento-metric-sub"><?= e(t('bento.card_perf_sub')) ?></span>
                    </div>
                </div>
            </div>

            <!-- Bento Card 4 (Span 2): Developer APIs -->
            <div class="bento-card bento-col-2">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-primary"><?= e(t('bento.card_api_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_api_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_api_desc')) ?></p>
                    <div class="bento-code-snippet">
                        <span style="color:var(--text-muted);">$</span> curl -s https://ternis.org/api/ver<br>
                        <span style="color:var(--primary);">{ "version": "<?= e(app_version_hash(true)) ?>", "commit": "<?= e(app_version_hash(false)) ?>" }</span>
                    </div>
                </div>
                <div class="bento-card-footer">
                    <span style="font-size:0.85rem; color:var(--text-muted); font-family:var(--font-mono);">JSON &bull; REST &bull; CORS Enabled</span>
                    <a href="https://getmy.name/api-docs" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-sm">
                        <span><?= e(t('bento.card_api_action')) ?></span>
                    </a>
                </div>
            </div>

            <!-- Bento Card 5 (Span 1): Managed Infrastructure via dnbx.de -->
            <div class="bento-card bento-col-1">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-secondary"><?= e(t('bento.card_dns_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_dns_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_dns_desc')) ?></p>
                    <div class="bento-badge-group">
                        <span class="badge badge-secondary" style="font-size:0.75rem;">Anycast DNS</span>
                        <span class="badge badge-secondary" style="font-size:0.75rem;">Auto TLS</span>
                        <span class="badge badge-secondary" style="font-size:0.75rem;">DNSSEC</span>
                    </div>
                </div>
                <div class="bento-card-footer">
                    <a href="https://dnbx.de" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-sm">
                        <span><?= e(t('bento.card_dns_action')) ?></span>
                    </a>
                </div>
            </div>

            <!-- Bento Card 2 (Span 2): S3 Object Storage with static.re -->
            <div class="bento-card bento-col-2">
                <div>
                    <div class="bento-card-header">
                        <span class="badge badge-accent"><?= e(t('bento.card_storage_badge')) ?></span>
                        <h3 class="bento-card-title"><?= e(t('bento.card_storage_title')) ?></h3>
                    </div>
                    <p class="bento-card-desc"><?= e(t('bento.card_storage_desc')) ?></p>
                    <div class="bento-badge-group">
                        <span class="badge badge-accent" style="font-size:0.75rem;">S3 Compatible</span>
                        <span class="badge badge-accent" style="font-size:0.75rem;">Cloudflare R2</span>
                        <span class="badge badge-accent" style="font-size:0.75rem;">Edge CDN</span>
                        <span class="badge badge-accent" style="font-size:0.75rem;">High Throughput</span>
                    </div>
                </div>
                <div class="bento-card-footer">
                    <span style="font-size:0.85rem; color:var(--text-muted); font-family:var(--font-mono);">Open Storage Tooling Platform</span>
                    <a href="https://static.re" target="_blank" rel="noopener noreferrer" class="btn btn-outline btn-sm">
                        <span>static.re</span>
                    </a>
                </div>
            </div>
...
<section id="projects" style="padding-top: 3rem;">
    <div class="container">
        <div class="section-header" style="margin-bottom: 2.5rem;">
